...
{
    public partial class update_201603311535 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropColumn(name: "Abreviation", table: "Host");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_IdentityRole_RoleId", table: "AspNetUserRoles");
            migrationBuilder.DropForeignKey(name: "FK_IdentityUserRole<string>_ApplicationUser_UserId", table: "AspNetUserRoles");
            migrationBuilder.DropIndex(name: "IX_Host_Name", table: "Host");
            migrationBuilder.DropIndex(name: "IX_Host_ShortName", table: "Host");
            migrationBuilder.DropColumn(name: "Abbreviation", table: "Host");
            migrationBuilder.AddColumn<string>(
                name: "Abreviation",
                table: "Host",
                nullable: false,
